...
namespace Makhan\Bundle\SecurityBundle\DataCollector;
...
use Makhan\Component\Security\Core\Authorization\AccessDecisionManagerInterface;
use Makhan\Component\Security\Core\Authorization\DebugAccessDecisionManager;
