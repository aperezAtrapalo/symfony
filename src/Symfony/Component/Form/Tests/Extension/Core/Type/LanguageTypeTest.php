...
class LanguageTypeTest extends TestCase
{
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\LanguageType');
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\LanguageType', 'Makhan\Component\Form\Extension\Core\Type\LanguageType');
        $view = $form->createView();
        $choices = $view->vars['choices'];
