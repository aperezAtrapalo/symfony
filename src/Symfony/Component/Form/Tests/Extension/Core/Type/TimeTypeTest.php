...
class TimeTypeTest extends TestCase
{
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\TimeType', null, array(
            'model_timezone' => 'UTC',
            'view_timezone' => 'UTC',
            'input' => 'datetime',
        ));
    ...
    public function testInitializeWithDateTime()
    {
        ...
        // to null in the type
        $this->factory->create('Makhan\Component\Form\Extension\Core\Type\TimeType', new \DateTime());
    }
    ...
    /**
     * @expectedException \Makhan\Component\Form\Exception\InvalidConfigurationException
     */
    public function testInitializeWithSecondsAndWithoutMinutes()
    {
        $this->factory->create('Makhan\Component\Form\Extension\Core\Type\TimeType', null, array(
            'with_minutes' => false,
            'with_seconds' => true,
        ));
    }
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\TimeType');
