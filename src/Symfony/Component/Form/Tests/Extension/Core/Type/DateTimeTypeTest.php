...
class DateTimeTypeTest extends TestCase
{
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\DateTimeType', null, array(
            'model_timezone' => 'UTC',
            'view_timezone' => 'UTC',
            'date_widget' => 'choice',
            'years' => array(2010),
    ...
    public function testInitializeWithDateTime()
    {
        ...
        // to null in the type
        $this->factory->create('Makhan\Component\Form\Extension\Core\Type\DateTimeType', new \DateTime());
    }
    ...
    public function testDateTypeChoiceErrorsBubbleUp()
    {
        ...
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\DateTimeType', null);
