...
class CheckboxTypeTest extends \Makhan\Component\Form\Test\TypeTestCase
{
    public function testDataIsFalseByDefault()
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\CheckboxType');
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\CheckboxType', null, array('value' => 'foobar'));
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\CheckboxType', null, array('value' => ''));
        $form->setData(true);
        $view = $form->createView();
    ...
    {
        $form = $this->factory->create('Makhan\Component\Form\Extension\Core\Type\CheckboxType', null, array(
            'value' => 'foobar',
        ));
        $form->submit('foobar');
    ...
    public function testCustomModelTransformer($data, $checked)
    {
        ...
        $form = $this->factory->createBuilder('Makhan\Component\Form\Extension\Core\Type\CheckboxType')
