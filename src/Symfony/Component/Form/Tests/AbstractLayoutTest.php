...
use Makhan\Component\Form\Extension\Csrf\CsrfExtension;

abstract class AbstractLayoutTest extends \Makhan\Component\Form\Test\FormIntegrationTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->csrfTokenManager = $this->getMock('Makhan\Component\Security\Csrf\CsrfTokenManagerInterface');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\DateType');
        $view = $form->createView();
        $this->renderWidget($view, array('label' => 'foo'));
        $html = $this->renderLabel($view);
...
'
    ...
    public function testLabelFormatName()
    {
        $form = $this->factory->createNamedBuilder('myform')
            ->add('myfield', 'Makhan\Component\Form\Extension\Core\Type\TextType')
            ->getForm();
...
'
    ...
    public function testLabelFormatAsFormOption()
    {
        ...
        $form = $this->factory->createNamedBuilder('myform', 'Makhan\Component\Form\Extension\Core\Type\FormType', null, $options)
            ->add('myfield', 'Makhan\Component\Form\Extension\Core\Type\TextType')
            ->getForm();
        $view = $form->get('myfield')->createView();
        $html = $this->renderLabel($view);
...
'
    ...
    public function testLabelFormatOverriddenOption()
    {
        ...
        $form = $this->factory->createNamedBuilder('myform', 'Makhan\Component\Form\Extension\Core\Type\FormType', null, $options)
            ->add('myfield', 'Makhan\Component\Form\Extension\Core\Type\TextType', array('label_format' => 'field.%name%'))
            ->getForm();
        $view = $form->get('myfield')->createView();
        $html = $this->renderLabel($view);
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('myform', 'Makhan\Component\Form\Extension\Core\Type\FormType', null, array(
                'translation_domain' => false,
            ))
            ->add('mybutton', 'Makhan\Component\Form\Extension\Core\Type\ButtonType')
            ->getForm();
...
'
    ...
    public function testOverrideWidgetBlock()
    {
        ...
        $form = $this->factory->createNamed('text_id', 'Makhan\Component\Form\Extension\Core\Type\TextType');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\CheckboxType', true);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\CheckboxType', false);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\CheckboxType', false, array(
            'value' => 'foo&bar',
        ));
...
'
    ...
    public function testSingleChoice()
    {
        ...
        // https://github.com/makhan/makhan/issues/8942
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\ChoiceType', null, array(
            'choices' => array('a', 'b'),
            'multiple' => false,
            'expanded' => false,
            'attr' => array('size' => 2),
...
'
    ...
    public function testSingleChoiceRequiredWithPlaceholder()
    {
        ...
        // See https://github.com/makhan/makhan/pull/7678
        $this->assertWidgetMatchesXpath($form->createView(), array(),
'/select
    [@name="name"]
    [@required="required"]
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\ChoiceType', true, array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\ChoiceType', array('&a', '&c'), array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\CountryType', 'AT');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\CountryType', 'AT', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\DateTimeType', '2011-02-03 04:05:06', array(
            'input' => 'string',
            'with_seconds' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\DateTimeType', null, array(
            'input' => 'string',
...
'
    ...
    public function testDateTimeWithHourAndMinute()
    {
        ...
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\DateTimeType', $data, array(
            'input' => 'array',
            'required' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\DateType', '2011-02-03', array(
            'input' => 'string',
            'widget' => 'choice',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\DateType', null, array(
            'input' => 'string',
            'widget' => 'choice',
            'placeholder' => 'Change&Me',
            'required' => false,
...
'
    ...
    public function testDateErrorBubbling()
    {
        $form = $this->factory->createNamedBuilder('form', 'Makhan\Component\Form\Extension\Core\Type\FormType')
            ->add('date', 'Makhan\Component\Form\Extension\Core\Type\DateType')
            ->getForm();
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\BirthdayType', '2000-02-03', array(
            'input' => 'string',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\BirthdayType', '1950-01-01', array(
            'input' => 'string',
            'placeholder' => '',
            'required' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\EmailType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\EmailType', 'foo&bar', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\FileType');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\HiddenType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\IntegerType', 123);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\LanguageType', 'de');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\LocaleType', 'de_AT');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\MoneyType', 1234.56, array(
            'currency' => 'EUR',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\NumberType', 1234.56);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\PasswordType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\PasswordType', null, array(
            'always_empty' => false,
        ));
        $form->submit('foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\PasswordType', 'foo&bar', array(
            'attr' => array('maxlength' => 123),
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\PercentType', 0.1);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\RadioType', true);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\RadioType', false);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\RadioType', false, array(
            'value' => 'foo&bar',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\RangeType', 42, array('attr' => array('min' => 5)));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\RangeType', 42, array('attr' => array('min' => 5, 'max' => 57)));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\TextareaType', 'foo&bar', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\TextType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\TextType', 'foo&bar', array(
            'attr' => array('maxlength' => 123),
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\SearchType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\TimeType', '04:05:06', array(
            'input' => 'string',
            'with_seconds' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\TimeType', null, array(
            'input' => 'string',
            'placeholder' => 'Change&Me',
            'required' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('form', 'Makhan\Component\Form\Extension\Core\Type\FormType')
            ->add('time', 'Makhan\Component\Form\Extension\Core\Type\TimeType')
            ->getForm();
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\TimezoneType', 'Europe/Vienna');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\TimezoneType', null, array(
...
'
    ...
    public function testUrl()
    {
        ...
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\UrlType', $url);
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('name', 'Makhan\Component\Form\Extension\Core\Type\FormType', array('items' => array('one', 'two', 'three')))
            ->add('items', 'Makhan\Component\Form\Extension\Core\Type\CollectionType', array('allow_add' => true))
            ->getForm()
            ->createView();
    ...
    {
        $form = $this->factory->createNamedBuilder('', 'Makhan\Component\Form\Extension\Core\Type\FormType')
            ->add('child', 'Makhan\Component\Form\Extension\Core\Type\TextType')
            ->getForm();
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\ButtonType', null, array(
            'translation_domain' => false,
        ));
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\SubmitType');
    ...
    {
        $form = $this->factory->createNamed('name', 'Makhan\Component\Form\Extension\Core\Type\ResetType');
...
'/form
    ...
    {
        $form = $this->factory->createBuilder('Makhan\Component\Form\Extension\Core\Type\FormType', null, array(
                'method' => 'get',
                'action' => 'http://example.com/directory',
            ))
            ->add('file', 'Makhan\Component\Form\Extension\Core\Type\FileType')
            ->getForm();
    ...
    {
        $form = $this->factory->createNamed('text', 'Makhan\Component\Form\Extension\Core\Type\TextType', 'value', array(
            'required' => true,
            'disabled' => true,
    ...
    {
        $form = $this->factory->createNamed('button', 'Makhan\Component\Form\Extension\Core\Type\ButtonType', null, array(
            'disabled' => true,
    ...
    {
        $form = $this->factory->createNamed('textarea', 'Makhan\Component\Form\Extension\Core\Type\TextareaType', '  ');
    ...
    {
        $form = $this->factory->createBuilder('Makhan\Component\Form\Extension\Core\Type\FormType', array('textarea' => '  '))
            ->add('textarea', 'Makhan\Component\Form\Extension\Core\Type\TextareaType')
            ->getForm();
    ...
    public function testTranslatedAttributes()
    {
        $view = $this->factory->createNamedBuilder('name', 'Makhan\Component\Form\Extension\Core\Type\FormType')
            ->add('firstName', 'Makhan\Component\Form\Extension\Core\Type\TextType', array('attr' => array('title' => 'Foo')))
            ->add('lastName', 'Makhan\Component\Form\Extension\Core\Type\TextType', array('attr' => array('placeholder' => 'Bar')))
            ->getForm()
            ->createView();
    ...
    {
        $view = $this->factory->createNamedBuilder('name', 'Makhan\Component\Form\Extension\Core\Type\FormType', null, array(
                'translation_domain' => false,
            ))
            ->add('firstName', 'Makhan\Component\Form\Extension\Core\Type\TextType', array('attr' => array('title' => 'Foo')))
            ->add('lastName', 'Makhan\Component\Form\Extension\Core\Type\TextType', array('attr' => array('placeholder' => 'Bar')))
