...
namespace Makhan\Component\Security\Guard\Tests\Provider;

use Makhan\Component\Security\Guard\Provider\GuardAuthenticationProvider;
...
class GuardAuthenticationProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAuthenticate()
    {
        ...
        $authenticatorC = $this->getMock('Makhan\Component\Security\Guard\GuardAuthenticatorInterface');
        ...
        $mockedUser = $this->getMock('Makhan\Component\Security\Core\User\UserInterface');
        ...
        $authedToken = $this->getMock('Makhan\Component\Security\Core\Authentication\Token\TokenInterface');
        $authenticatorB->expects($this->once())
    ...
    /**
     * @expectedException \Makhan\Component\Security\Core\Exception\AuthenticationExpiredException
     */
    ...
    protected function setUp()
    {
        ...
        $this->preAuthenticationToken = $this->getMockBuilder('Makhan\Component\Security\Guard\Token\PreAuthenticationGuardToken')
