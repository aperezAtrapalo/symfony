...
namespace Makhan\Component\Security\Guard\Authenticator;

use Makhan\Component\Security\Guard\AbstractGuardAuthenticator;
...
abstract class AbstractFormLoginAuthenticator extends AbstractGuardAuthenticator
{
    ...
    {
        @trigger_error(sprintf('The AbstractFormLoginAuthenticator::onAuthenticationSuccess() implementation was deprecated in Makhan 3.1 and will be removed in Makhan 4.0. You should implement this method yourself in %s and remove getDefaultSuccessRedirectUrl().', get_class($this)), E_USER_DEPRECATED);
