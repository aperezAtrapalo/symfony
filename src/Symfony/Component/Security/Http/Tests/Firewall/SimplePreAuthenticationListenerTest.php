...
use Makhan\Component\Security\Http\Firewall\SimplePreAuthenticationListener;
...
class SimplePreAuthenticationListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testHandle()
    {
        ...
        $simpleAuthenticator = $this->getMock('Makhan\Component\Security\Http\Authentication\SimplePreAuthenticatorInterface');
        $simpleAuthenticator
            ->expects($this->once())
            ->method('createToken')
    ...
    protected function setUp()
    {
        ...
        $this->event = $this->getMock('Makhan\Component\HttpKernel\Event\GetResponseEvent', array(), array(), '', false);
        $this->event
            ->expects($this->any())
            ->method('getRequest')
