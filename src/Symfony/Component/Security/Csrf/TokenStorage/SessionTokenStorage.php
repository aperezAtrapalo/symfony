...
namespace Makhan\Component\Security\Csrf\TokenStorage;

use Makhan\Component\HttpFoundation\Session\SessionInterface;
use Makhan\Component\Security\Csrf\Exception\TokenNotFoundException;

/**
 * Token storage that uses a Makhan2 Session object.
 *
 * @since  2.4
 *
